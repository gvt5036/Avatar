...
<g transform="translate(30, 336)">
   <polygon transform="scale(-1, 1) translate(-590,-2)" points="{$pos * $xSpacer - 5},0 {$pos * $xSpacer - 5 + 5}, 0 {$pos * $xSpacer - 5 + 5}, -{$distSpkCount * $ySpacer} {$pos * $xSpacer - 5}, -{$distSpkCount * $ySpacer + 2}" fill="url(#grad2)" stroke="black"/>
   ...
   <text x="155" y="-320" font-size="20" font-family="georgia">Distinct Characters Per Episode</text>
</g>
}
</g>
</svg>